...
var len__42350__auto___43809 = arguments.length;
var i__42351__auto___43810 = (0);
while(true){
if((i__42351__auto___43810 < len__42350__auto___43809)){
args__42357__auto__.push((arguments[i__42351__auto___43810]));

var G__43811 = (i__42351__auto___43810 + (1));
i__42351__auto___43810 = G__43811;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__42358__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq43807){
var G__43808 = cljs.core.first.call(null,seq43807);
var seq43807__$1 = cljs.core.next.call(null,seq43807);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__43808,seq43807__$1);
});
...
return (p1__43812_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1524597514735
