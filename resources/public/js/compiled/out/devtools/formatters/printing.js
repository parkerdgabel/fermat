...
var len__42350__auto___43818 = arguments.length;
var i__42351__auto___43819 = (0);
while(true){
if((i__42351__auto___43819 < len__42350__auto___43818)){
args__42357__auto__.push((arguments[i__42351__auto___43819]));

var G__43820 = (i__42351__auto___43819 + (1));
i__42351__auto___43819 = G__43820;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__42358__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq43815){
var G__43816 = cljs.core.first.call(null,seq43815);
var seq43815__$1 = cljs.core.next.call(null,seq43815);
var G__43817 = cljs.core.first.call(null,seq43815__$1);
var seq43815__$2 = cljs.core.next.call(null,seq43815__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__43816,G__43817,seq43815__$2);
});
...
if(cljs.core.truth_((function (){var or__41071__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__41742__auto__,writer__41743__auto__,opt__41744__auto__){
return cljs.core._write.call(null,writer__41743__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__41059__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__41059__auto__){
var or__41071__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__41071__auto__)){
return or__41071__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__43821_SHARP_){
return !((cljs.core.meta.call(null,p1__43821_SHARP_) == null));
})))){
...
var map__43822 = opts;
var map__43822__$1 = ((((!((map__43822 == null)))?((((map__43822.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__43822.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__43822):map__43822);
var markup_db = cljs.core.get.call(null,map__43822__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__41071__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e43826){var _e__42775__auto__ = e43826;
return false;
}})();
if(cljs.core.truth_(or__41071__auto__)){
return or__41071__auto__;
...
}catch (e43828){var _e__42775__auto__ = e43828;
return false;
}}
})())){
...
var _STAR_current_state_STAR_43830 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__43831 = opts;
...
var markup_db = cljs.core.get.call(null,map__43831__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_43830;
}});
...
;
var temp__5455__auto___43835 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___43835)){
var managed_print_level_43836 = temp__5455__auto___43835;
var _STAR_print_level_STAR_43834_43837 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_43836;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_43834_43837,managed_print_level_43836,temp__5455__auto___43835,writer,opts,job_fn){
return (function (p1__43833_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__43833_SHARP_,null);
});})(_STAR_print_level_STAR_43834_43837,managed_print_level_43836,temp__5455__auto___43835,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_43834_43837;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1524597514833
