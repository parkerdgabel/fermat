...
var G__43789 = devtools.prefs.pref.call(null,v);
v = G__43789;
continue;
} else {
return v;
...
var and__41059__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__41059__auto__){
var and__41059__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__41071__auto__ = (function (){try{if(!((value == null))){
...
}catch (e43792){var _e__42775__auto__ = e43792;
return false;
}})();
if(cljs.core.truth_(or__41071__auto__)){
return or__41071__auto__;
} else {
var or__41071__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e43796){var _e__42775__auto__ = e43796;
return false;
}})();
...
}catch (e43798){var _e__42775__auto__ = e43798;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__41059__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__41059__auto__)){
var and__41059__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__41059__auto____$1){
...
var and__41059__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__41059__auto__)){
...
var or__41071__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__41071__auto__)){
return or__41071__auto__;
} else {
...
var and__41059__auto__ = (function (){var or__41071__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__41071__auto__)){
return or__41071__auto__;
} else {
...
var vec__43800 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__43800,(0),null);
var name = cljs.core.nth.call(null,vec__43800,(1),null);
...
var and__41059__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__41059__auto__)){
...
var or__41071__auto__ = typeof value === 'string';
if(or__41071__auto__){
return or__41071__auto__;
} else {
var or__41071__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__43803_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__43803_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1524597514702
