...
return cljs.core.not.call(null,(function (){var and__41059__auto__ = goog.labs.userAgent.browser.isChrome();
...
var o__42768__auto___46050 = (function (){var o__42768__auto__ = (function (){var o__42768__auto__ = Promise;
return (o__42768__auto__["resolve"]).call(o__42768__auto__);
})();
return (o__42768__auto__["then"]).call(o__42768__auto__,callback);
})();
(o__42768__auto___46050["catch"]).call(o__42768__auto___46050,devtools.async.rethrow_outside_promise);
...
var G__46051_46052 = Error;
var target__42773__auto___46053 = G__46051_46052;
if(cljs.core.truth_(target__42773__auto___46053)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["unable to locate object path ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(null)," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__46051_46052)].join('')),"\n","target__42773__auto__"].join('')));
}

(target__42773__auto___46053["stackTraceLimit"] = Infinity);
...
//# sourceMappingURL=async.js.map?rel=1524597518987
