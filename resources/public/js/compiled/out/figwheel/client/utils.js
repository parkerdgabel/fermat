...
var or__41071__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj49464 = {"detail":data};
return obj49464;
})()));
} else {
...
var and__41059__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__49471 = cljs.core._EQ_;
var expr__49472 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__49471.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__49472))){
return ((function (pred__49471,expr__49472){
return (function (p1__49465_SHARP_){
return console.warn(p1__49465_SHARP_);
});
;})(pred__49471,expr__49472))
} else {
if(cljs.core.truth_(pred__49471.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__49472))){
return ((function (pred__49471,expr__49472){
return (function (p1__49466_SHARP_){
return console.debug(p1__49466_SHARP_);
});
;})(pred__49471,expr__49472))
} else {
if(cljs.core.truth_(pred__49471.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__49472))){
return ((function (pred__49471,expr__49472){
return (function (p1__49467_SHARP_){
return console.error(p1__49467_SHARP_);
});
;})(pred__49471,expr__49472))
} else {
return ((function (pred__49471,expr__49472){
return (function (p1__49468_SHARP_){
return console.log(p1__49468_SHARP_);
});
;})(pred__49471,expr__49472))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__49475){
...
var opts = map__49476__$1;
var eval_fn = cljs.core.get.call(null,map__49476__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__49478_SHARP_);
});})(new_def))
);
...
return (function (p__49479){
var vec__49480 = p__49479;
var ky = cljs.core.nth.call(null,vec__49480,(0),null);
var v = cljs.core.nth.call(null,vec__49480,(1),null);
...
if(cljs.core.truth_((function (){var and__41059__auto__ = figwheel.client.utils.feature_QMARK_.call(null,localStorage,"getItem");
if(cljs.core.truth_(and__41059__auto__)){
...
}catch (e49485){if((e49485 instanceof Error)){
var e = e49485;
return not_found;
} else {
throw e49485;
...
//# sourceMappingURL=utils.js.map?rel=1524597521258
